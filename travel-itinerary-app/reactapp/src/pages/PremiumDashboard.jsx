...
// // function PremiumTravelerDashboard() {
...
// //       <h1>Welcome, Premium Traveler 🌟</h1>
...
// // export default PremiumTravelerDashboard;
...
//         <h2>Premium Traveler</h2>
//         <ul>
//           <li onClick={() => setActiveTab("itineraries")} className={activeTab === "itineraries" ? "active" : ""}>📌 Itineraries</li>
//           <li onClick={() => setActiveTab("bookings")} className={activeTab === "bookings" ? "active" : ""}>📅 Bookings</li>
//           <li onClick={() => setActiveTab("expenses")} className={activeTab === "expenses" ? "active" : ""}>💰 Expenses</li>
...
// // //           {/* Add other premium links if needed */}
// // //         </ul>
// // //       </aside>

// // //       <main className="dashboard-content">
// // //         <Routes>
// // //           <Route path="" element={<h1>Welcome, Premium User ⭐</h1>} />
// // //           {/* <Route path="itineraries" element={<Itineraries role={role} />} /> */}
// // //           <Route path="itineraries" element={<Itineraries role="PREMIUM" />} />
// // //         </Routes>
// // //       </main>
